...
protocol TabBarLogic: AnyObject {
    ...
    func createNavigationViewController(rootViewController: UIViewController, title: String, image: UIImage) -> UIViewController
}

final class TabBarViewController: UITabBarController {
    
    private var imagesController = ModulBuilder.createImagesModule(flowLayout: UICollectionViewFlowLayout())
    private var favoriteImageController = FavoriteViewController()
